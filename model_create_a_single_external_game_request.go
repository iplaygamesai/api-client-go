...
// checks if the CreateASingleExternalGameRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateASingleExternalGameRequest{}

// CreateASingleExternalGameRequest struct for CreateASingleExternalGameRequest
type CreateASingleExternalGameRequest struct {
...
type _CreateASingleExternalGameRequest CreateASingleExternalGameRequest
...
func NewCreateASingleExternalGameRequest(externalGameId string, name string) *CreateASingleExternalGameRequest {
	this := CreateASingleExternalGameRequest{}
...
func (o *CreateASingleExternalGameRequest) SetProducerNameNil() {
...
func (o *CreateASingleExternalGameRequest) SetImageUrlNil() {
	o.ImageUrl.Set(nil)
}
...
func (o CreateASingleExternalGameRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateASingleExternalGameRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CreateASingleExternalGameRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateASingleExternalGameRequest := _CreateASingleExternalGameRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateASingleExternalGameRequest)

	if err != nil {
		return err
	}

	*o = CreateASingleExternalGameRequest(varCreateASingleExternalGameRequest)

	return err
}

type NullableCreateASingleExternalGameRequest struct {
	value *CreateASingleExternalGameRequest
	isSet bool
}

func (v NullableCreateASingleExternalGameRequest) Get() *CreateASingleExternalGameRequest {
	return v.value
}

func (v *NullableCreateASingleExternalGameRequest) Set(val *CreateASingleExternalGameRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateASingleExternalGameRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateASingleExternalGameRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateASingleExternalGameRequest(val *CreateASingleExternalGameRequest) *NullableCreateASingleExternalGameRequest {
	return &NullableCreateASingleExternalGameRequest{value: val, isSet: true}
}

func (v NullableCreateASingleExternalGameRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateASingleExternalGameRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
